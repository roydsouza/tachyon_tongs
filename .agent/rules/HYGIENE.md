...
7.  **Sidecar Proliferation**: SQLite `-wal` and `-shm` files are considered root-clutter and MUST be localized to the database's containing directory (e.g., `tests/tmp/`).
